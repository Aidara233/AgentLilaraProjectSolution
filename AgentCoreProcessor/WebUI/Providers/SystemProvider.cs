...
internal class SystemProvider : IWebUIProvider
{
    ...
    {
        Route = "system",
        Meta = new PageMeta { Title = "概览", Icon = "bi-gear", Group = "系统引擎", Order = 30 },
    ...
    {
        Route = "system/events",
        Meta = new PageMeta { Title = "事件队列", Icon = "bi-inbox", Group = "系统引擎", Order = 31 },
        Cards = new List<CardDefinition>
        {
            new()
            {
    ...
    {
        Route = "system/agents",
        Meta = new PageMeta { Title = "子agent", Icon = "bi-people", Group = "系统引擎", Order = 32 },
        Cards = new List<CardDefinition>
        {
            new()
            {
