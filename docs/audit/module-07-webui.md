...
**2. SystemMonitor 双重构建快照对象** (`SystemMonitor.cs:57-82`) ✅ 已修复 2026-05-26
```csharp
...
**3. DataSourceManager.FetchAsync 第二个 catch 块不可达** (`DataSourceManager.cs:53-76`) ✅ 已修复 2026-05-26
```csharp
...
**5. NavConfig.Items 死代码** (`NavConfig.cs:5-9`) ✅ 已修复 2026-05-26
```csharp
...
**7. AlertService.providers 无线程安全** (`AlertService.cs:9`) ✅ 已修复 2026-05-26
```csharp
...
**9. ProviderRegistry.Unregister 中 builtIn 保护的逻辑有误** (`ProviderRegistry.cs:27-35`) ✅ 已修复 2026-05-26
```csharp
if (entry.BuiltIn)
{
...
**10. ModelLogService.ListRecent 先 Take(count*3) 再 callerFilter 再 Take(count)** (`ModelLogService.cs:79-98`) ✅ 已修复 2026-05-26
